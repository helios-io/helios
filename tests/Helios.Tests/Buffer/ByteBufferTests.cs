...
namespace Helios.Tests.Buffer
{
    ...
    public class ByteBufferTests
    {
        ...
        {
            var byteBuffer = ByteBuffer.AllocateDirect(10, 10);
        ...
        {
            var byteBuffer = ByteBuffer.AllocateDirect(16, 16);
        ...
        {
            var originalBuffer = ByteBuffer.AllocateDirect(1024);
            var destinationBuffer = ByteBuffer.AllocateDirect(1024);
