...
Helios is a large project and contributions are more than welcome, so thank you for wanting to contribute!
...
- Fork by clicking _Fork_ on https://github.com/helios-io/helios
...
```
git remote add upstream https://github.com/helios-io/helios
```
You now have two remotes: _upstream_ points to https://github.com/helios-io/helios, and _origin_ points to your fork on GitHub.

- Make changes. See below. 

Unsure where to start? Issues marked with [_up for grabs_](https://github.com/helios-io/helios/labels/up%20for%20grabs) are things we want help with.
...
- Pick an [issue](https://github.com/helios-io/helios/issues). If no issue exists (search first) create one. 
