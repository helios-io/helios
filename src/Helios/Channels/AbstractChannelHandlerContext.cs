...
#pragma warning restore 420
        ...
        protected AbstractChannelHandlerContext(IChannelPipeline pipeline, IChannelHandlerInvoker invoker, string name, int skipPropagationFlags)
        {
        ...
        {
            var next = this.FindContextInbound();
        ...
        public Task WriteAndFlushAsync(object message)
        {
            ...
            Task writeTask = target.Invoker.InvokeWriteAsync(target, message);
        ...
        class PausableChannelEventExecutorImpl : PausableChannelEventExecutor
        {
            ...
            public override bool IsAcceptingNewTasks => ((PausableChannelEventExecutor)Channel.EventLoop).IsAcceptingNewTasks;
