...
namespace Helios.Reactor
{
    ...
    public abstract class ProxyReactorBase<TIdentifier> : ReactorBase
    {
        ...
        protected ProxyReactorBase(IPAddress localAddress, int localPort, IEventLoop eventLoop, SocketType socketType = SocketType.Stream, ProtocolType protocol = ProtocolType.Tcp, int bufferSize = NetworkConstants.DEFAULT_BUFFER_SIZE) 
