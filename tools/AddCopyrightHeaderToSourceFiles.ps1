$lineBreak = "`r`n"
$noticeTemplate = "// Copyright (c) Petabridge <https://petabridge.com/>. All rights reserved.$lineBreak// Licensed under the Apache 2.0 license. See LICENSE file in the project root for full license information.$lineBreak// See ThirdPartyNotices.txt for references to third party code used inside Helios.$lineBreak$lineBreak"
...
Function SourceFileContainsNotice($sourcePath){
    $copyrightSnippet = [regex]::Escape("// Copyright (c) Petabridge")
